...
<div>
    ...
    <p style="font-weight: bold; font-size: 0.9rem;" class="text-center">Laporan Barang Keluar</p>
                    ...
                    <table style=" table-layout: auto; border: none; width: 400px">
                        ...
                        <tr style="border: 0;  ">
                            ...
                            <td class="text-left" style="margin-bottom: 0; font-size: 11px">
                                {{ \Carbon\Carbon::parse($date_start)->format('d F Y') }}
                                - {{ \Carbon\Carbon::parse($date_end)->format('d F Y') }}
                            </td>
                        </tr>
...
{{-- BARANG DITERIMA --}}
<p style="font-size: 0.9rem">Daftar Barang Keluar</p>
<div class="panel">
    ...
    <table style="margin-bottom: 10px" class="stripe-table">
        ...
        <tr style="border-bottom: 1px solid #ccc">
            ...
            <th class="text-center text-ontable">Nomor Batch</th>
            <th class="text-center text-ontable " style="width: 200px">Tanggal Datang</th>
            <th class="text-center text-ontable">Unit Penerima</th>
        </tr>
        ...
        @foreach($data as $value)
            <tr style="border-bottom: 1px solid #ccc">
                ...
                <td class="text-center text-ontable">{{ $value->location->name }}</td>
            </tr>
        @endforeach
        </tbody>
    </table>
...
<table style="margin-bottom: 10px" class="stripe-table">
    ...
    @endphp
    @foreach($data as $value)
        @foreach($value->medicine_outs as $detail)
            <tr style="border-bottom: 1px solid #ccc">
