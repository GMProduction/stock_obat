                ...
                <div id="modal_periode" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative w-full max-w-sm h-full md:h-auto">
                        ...
                        <div class="relative bg-white rounded-lg shadow p-4 ">
                            ...
                            {{-- MODAL ISI --}}
                            <div class="flex items-center">
                                <div class=" mt-3 mb-5 block grow">
                                    <div class="relative">
                                        ...
                                        <input name="Date" type="text" datepicker datepicker-autohide
                                            class="bg-gray-50  border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="Tanggal">
                                    </div>
                                </div>
                                <button type="button" id="btn-add-cart"
                                    class="w-6 flex ml-3 justify-center items-center text-white bg-red-500 hover:bg-red-300 focus:ring-4  font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 transition duration-300  focus:outline-none ">
