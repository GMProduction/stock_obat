    ...
    <div class="panel min-h-screen">
        ...
        <div class="grid grid-cols-1 gap-4">
            <div class="section relative">
                ...
                <table id="tb-master-obat" class="hover mt-10" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                    <thead>
                        <tr>
            ...
            <div class="relative p-4 w-full max-w-4xl h-full md:h-auto">
                ...
                <div class="relative bg-white rounded-lg shadow ">
                    ...
                    <form onsubmit="return saveMedicine()" id="form-patch">
                        ...
                        <div class="p-6 ">
                            <div class="mb-3">
                                <label for="nama-barang" class="block mb-2 text-sm font-medium text-gray-700 mt-3">Nama
                                    Barang </label>
                            ...
                            <div class="flex flex-col">
                                <span id="tooltip-tambahsatuan"
                                    class="block mb-2 text-xs font-bold text-red-500 dark:text-white">
