        ...
        <div id="modal_tambahLokasi" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                ...
                <div class="relative bg-white rounded-lg shadow ">
                    ...
                    {{-- FORM --}}
                    <form onsubmit="return saveData()" id="form-patch">
                        @csrf
...
@section('morejs')
    ...
    <script>
        $(document).ready(function () {
            ...
            // Modal Function
            table('tb-lokasi', '{{route('masterlokasidatatable')}}')
    ...
    <script>
      ...
      $(document).on('click', '#editData', function () {
        ...
        function saveData() {
            confirmSave('Simpan Data', 'apa anda yakin ?','form-patch','{{route('masterlokasi')}}',responseSave )
            return false;
        }

        function responseSave() {
            modaltambahlHide();
            $("#tb-lokasi").DataTable().ajax.reload();
        }
