...
<body>
        ...
        <table style="margin-bottom: 10px" class="stripe-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="text-right text-ontable" style="width: 20px">
                        2
                    </td>
                    <td class="text-left text-ontable">
                        Tablet
    ...
    <div class="panel" style="margin-top: 10px; padding: 8px">
        ...
        <p style="margin: 0; margin-top: 8px; padding: 0; color: #444" class="text-sm">Catatan Catatan Catatan Catatan
            Catatan Catatan Catatan Catatan Catatan Catatan Catatan Catatan Catatan Catatan Catatan Catatan Catatan
            Catatan Catatan Catatan Catatan Catatan Catatan Catatan Catatan Catatan Catatan Catatan </p>
    </div>
    <br>
