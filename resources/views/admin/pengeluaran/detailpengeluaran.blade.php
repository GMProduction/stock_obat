            ...
            <div class="section relative min-h-[600px]">
                ...
                <div class="grid grid-cols-3 gap-2 ">
                    ...
                    <div class="border rounded-md p-3">
                        ...
                        <div class="mb-3 ">
                            <label for="total" class="block mb-2 text-sm font-medium text-gray-700 mt-3">Unit Tujuan
                            </label>
                            <input type="text" id="total"
                                class="bg-gray-200  border  w-full p-1 border-gray-300 text-gray-900 rounded-sm text-sm  block "
                                readonly name="total" />
                        ...
                        <div class="mb-3 mt-5">
                            ...
                            <textarea type="text" id="description" readonly
                                ...
                                placeholder="Catatan Keluaran" name="description"></textarea>
                        </div>
                    </div>
                ...
                <div class="flex items-center justify-between pt-6 rounded-b border-t border-gray-200 ">
                    ...
                    <button type="submit" id="btn-save" form="form-save" onclick="location.href='/pengeluaran/suratbarangkeluar/1'"
