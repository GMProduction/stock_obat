    ...
    <div class="panel min-h-screen">
        ...
        <div class="grid grid-cols-1 gap-4">
            <div class="section relative">
                <p class="title ">Nama Barang <span class="text-xs text-red-500"> {{$data->name}}</span></p>
    ...
    <script>
        ...
        function datatableDetail() {
            let colums = [
                ...
                {data: 'transaction_in.budget_source.name', name: 'transaction_in.budget_source.name'},
                {data: 'transaction_in.batch_id', name: 'transaction_in.batch_id'},
                {data: 'lokasi', name: 'lokasi'},
                {
                    data: 'expired_date', name: 'expired_date', render: function (data) {
                ...
                {
                    data: 'price', name: 'price', className: 'text-right', render: function (data) {
                        return data.toLocaleString()
                    }
                },
                {
                    data: 'total', name: 'total', className: 'text-right', render: function (data) {
                        return data.toLocaleString()
                    }
                },
                // {
            ...
            datatable('tb-min-stock', '{{route('stockbarang.datatable',['id' => request('id')])}}', colums, createdRow,[[4,'ASC']])
        }
    </script>
@endsection
