...
@section('css')
    ...
    <link href="{{ asset('local/monthpicker/MonthPicker.min.css') }}" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" type="text/css" href="{{ asset('local/monthpicker/examples.css') }}" />
    <script src="{{ asset('local/monthpicker/MonthPicker.min.js') }}"></script>
@endsection
@section('content')
                ...
                <table id="tb-master" class="stripe hover mt-10"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-priority="2" class="text-center text-xs">Nomor Batch</th>
                            <th data-priority="2" class="text-left text-xs">Tanggal</th>
                            <th data-priority="2" class="text-center text-xs">Keterangan</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td data-priority="2" class="text-center text-xs">123</td>
                            <td data-priority="2" class="text-left text-xs">12 Desember 2023</td>
                            <td data-priority="2" class="text-center text-xs">Ini Keterangan</td>
...
@section('morejs')
    ...
    <script src="{{ asset('local/monthpicker/examples.js') }}"></script>
