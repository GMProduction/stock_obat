            ...
            <div class="section relative min-h-[600px]">
                ...
                <div class="grid grid-cols-3 gap-2 ">
                    ...
                    <div class="border rounded-md col-span-2 p-3 relative">
                        ...
                        <table id="tb-master" class="table display table-auto stripe hover mt-10 "
                               style="width:100%;">
                        ...
                        <form method="post" id="form-save">
                            ...
                            <div class="mb-3 mt-5">
                                ...
                                <textarea type="text" id="description"
                                          ...
                                          rows="4" placeholder="Catatan Penerimaan"
        ...
        <div id="modal_tambahBarang" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-4xl h-full md:h-auto">
                ...
                <div class="relative bg-white rounded-lg shadow ">
                    ...
                    <form method="post" action="{{ route('tambahbarang.cart') }}"
                          id="form-cart">
                        @csrf
                        ...
                        <div class="p-6 ">
                            <label for="budget_source" class="block mb-2 text-sm font-medium text-gray-900 ">Pilih
                                Barang</label>
                            <select
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            table = BasicDatatableGenerator('#tb-master', path, [
                ...
                {
                    data: 'medicine.name', name: 'medicine.name', className: 'text-left text-xs'
                },

                {data: 'unit.name', name: 'unit.name', className: 'text-center text-xs'},
                {
                    data: 'expired_date',
                    name: 'expired_date',
                    className: 'text-center text-xs',
                ...
                {data: 'qty', name: 'qty', className: 'text-center text-xs'},
                {
                    data: 'price',
                    name: 'price',
                ...
                },
                {
                    ...
                    data: null, render: function (data) {
                        return '<button data-id="' + data['id'] + '" class="bg-secondary rounded-full text-white px-3 py-2 btn-detail text-xs">Hapus</button>';
                    }
                },
            ], [], function (d) {
